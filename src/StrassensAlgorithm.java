...
public class StrassensAlgorithm {
    ...
    public int[][] multiply(int[][] A, int[][] B) {
        ...
        // Creating a 2D square matrix with size n, n is input from the user
        int[][] R = new int[n][n];
    ...
    public static void main(String[] args) {
        ...
        // Create an object of Strassen class in the main function
        StrassensAlgorithm s = new StrassensAlgorithm();
